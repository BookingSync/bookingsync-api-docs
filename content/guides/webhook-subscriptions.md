...
<img src="/static/images/webhook-subscriptions/webhooks-tab.png" alt="webhooks-tab" style="width:70%" />

Now, go to the "Webhook" section and click "New Webhook" to access the webhook subscriptions form.

### Webhook subscription form

<img src="/static/images/webhook-subscriptions/webhooks-form.png" alt="webhooks-form" style="width:70%" />
