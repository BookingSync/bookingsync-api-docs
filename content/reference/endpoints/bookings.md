...
damage_deposit_collection_method               | [String](/reference/enums/#damage-deposit-collection-methods) | Read/Write | Booking's damage deposit collection method. | List of values described in [enums section](/reference/enums#damage-deposit-collection-methods). |
...
damage_deposit_collection_method | [String](/reference/enums/#damage-deposit-collection-methods) | Read | Booking's damage deposit collection method. List of values described in [enums section](/reference/enums#damage-deposit-collection-methods).
