...
* account_destroyed
* account_updated
* accounts_application_created
* accounts_application_destroyed
* accounts_application_updated
...
* booking_comment_created
* booking_comment_destroyed
* booking_comment_updated
* booking_created
* booking_destroyed
...
* booking_updated
* bookings_fee_created
* bookings_fee_destroyed
* bookings_fee_updated
* bookings_tags_item_created
* bookings_tags_item_destroyed
* client_created
* client_destroyed
* client_updated
* fee_created
